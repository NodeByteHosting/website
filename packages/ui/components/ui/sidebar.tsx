...
function SidebarProvider({
  ...
  React.useEffect(() => { toggleSidebarRef.current = toggleSidebar })
...
function SidebarMenuSkeleton({
  ...
  // Width between 50 to 90% — deterministic from a stable id
  const width = `${(parseInt(React.useId().slice(-4), 36) % 40) + 50}%`
