...
const WhyChooseUs: FC = () => {
    ...
    const BENEFITS_LIST = [
        ...
        },
        {
            ...
            content: "Set up your Rust server with full modding support, allowing for endless customization and unique gameplay experiences.",
        },
        {
            icon: <Shield strokeWidth={1.5} size={24} />,
            title: "DDoS Protection",
            content: "Keep your Rust server safe with our enterprise grade DDoS protection, ensuring your players can connect without interruption.",
        },
        {
            icon: <Settings strokeWidth={1.5} size={24} />,
            title: "Easy Management",
            content: "Control your Rust server through our intuitive panel. Configure settings with just a few clicks.",
        },
        {
            icon: <Clock strokeWidth={1.5} size={24} />,
            title: "Instant Setup",
            content: "Get your Rust server up and running in minutes with our automated setup process. No technical knowledge required.",
        },
        {
                ...
                <section className={s.Wrapper}>
                    ...
                    >
                        ...
                        <motion.p variants={animation} custom={3} className="text-white/50">
                            Experience premium Rust hosting with features designed for the perfect gameplay experience.
                        </motion.p>
                    </motion.section>
