...
import { VPS_DATA_CARDS } from "@/src/constants/services/vpsData";
...
const ServersList: FC = () => {
    ...
    const NoServersMessage: FC = () => (
        ...
        >
            ...
            <h3 className="text-2xl font-bold text-white mb-2">
                Whoops! No VPS Servers Available
            </h3>
    ...
    const availableServers = VPS_DATA_CARDS.filter(card => !card.outOfStock);
                ...
                <section className={s.Wrapper}>
                    ...
                    >
                        ...
                        <motion.p variants={animation} custom={3} className="text-gray">
                            Choose from a variety of VPS configurations to suit your needs.
                        </motion.p>
                    </motion.section>
                    {availableServers.length > 0
                        ? renderCards(VPS_DATA_CARDS)
                        : <NoServersMessage />
                    }
                </section>
            </div>
