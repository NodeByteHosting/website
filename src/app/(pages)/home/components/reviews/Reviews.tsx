                ...
                <section className={s.Wrapper}>
                    ...
                    <section className="mt-6">
                        {reviews.length > 0 ? (
                            ...
                            <div className="text-gray text-sm flex items-center gap-2">
                                <InfoIcon />{" "}<p>We are unable to load the reviews right now, you can still find them on <Link href="https://www.trustpilot.com/review/nodebyte.host" className="text-green hover:text-blue">trustpilot</Link>.</p>
                            </div>
                        )}
                    </section>
                </section>
